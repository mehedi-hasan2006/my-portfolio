...
const CoderProfileCard = () => {
  return (
    <div className="container mx-auto bg-linear-to-r from-zinc-100 to-zinc-200 dark:from-[#000000] dark:to-[#0a0d37] border-zinc-300 dark:border-[#1b2c68a0] relative rounded-lg border shadow-lg">
      {}
...
const Hero = () => {
  return (
    <div className="min-h-screen container mx-auto mt-5 relative flex items-center justify-center font-sans p-4 sm:p-6 lg:p-8">
      {}
      <div
